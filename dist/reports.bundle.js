...
(function (exports,main_core,ui_vue3,ui_ears,ui_vue3_pinia) {
    ...
    var _ref = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee() {
      ...
      return _regeneratorRuntime$1().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            response = _context.sent;
            workPos = response["answer"]["result"]["work_position"];
            if (WORK_POSITIONS_DIRECTORATE.includes(workPos)) {
              workPos = "Дирекция";
            }
            return _context.abrupt("return", workPos);
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            console.error("Error fetching data:", _context.t0);
  ...
  var getUsersByPosition$1 = /*#__PURE__*/function () {
    var _ref2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee2(positionToSearch) {
      var response;
  ...
  var collectDefaultData = /*#__PURE__*/function () {
    var _ref3 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee3(workPos) {
  ...
  var createFilename = /*#__PURE__*/function () {
    var _ref4 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee4(reportName) {
      var response, userId, currentDate;
      return _regeneratorRuntime$1().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            userId = response["answer"]["result"]["id"];
            currentDate = new Date();
            return _context4.abrupt("return", userId + reportName + currentDate.getFullYear() + currentDate.getMonth() + currentDate.getDay() + currentDate.getTime());
          case 6:
          case "end":
            return _context4.stop();
        }
  ...
  var getReportFrom1C = /*#__PURE__*/function () {
    var _ref5 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee5(xml, filename) {
      ...
      return _regeneratorRuntime$1().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 10;
            return fetch(BITRIX_URL + "/1cApi/getReport", {
              method: "POST",
              body: formData
            });
          case 10:
  ...
  var downloadReportFile = /*#__PURE__*/function () {
    var _ref6 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee6(fileId) {
  ...
  var goToEdit = /*#__PURE__*/function () {
    var _ref7 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee7(fileId) {
  ...
  var getUserClients$1 = /*#__PURE__*/function () {
    var _ref8 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee8(userGuid) {
      var response, result;
      return _regeneratorRuntime$1().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            _context8.prev = 0;
            _context8.next = 3;
            return fetch(BITRIX_URL + "/1cApi/getPartners/".concat(userGuid), {
              method: "GET"
            });
          case 3:
          ...
          case 6:
            ...
            return _context8.abrupt("return", result.body);
          case 9:
  ...
  var getHierarchy$1 = /*#__PURE__*/function () {
    var _ref9 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee9() {
  ...
  var getUserDiskId = /*#__PURE__*/function () {
    var _ref10 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee10() {
      var response, userId, response2;
      return _regeneratorRuntime$1().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 6:
            response2 = _context10.sent;
            return _context10.abrupt("return", response2["answer"]["result"][0]["ID"]);
          case 8:
          case "end":
